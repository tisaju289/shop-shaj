...
// Server-side Supabase client. A service-role key is optional; deployments that
// only provide the publishable key use the same RLS-protected client as the app.
